    ...
    return (
        <button disabled={isSelected} onClick={() => {
            ...
            <div className='bg-white p-5 rounded-2xl shadow-2xl'>
                <div className='flex justify-between gap-20'><p className='text-xl font-semibold text-gray-800'>{ticket.title}</p><button  className={`btn rounded-2xl border-0 ${isSelected ? "bg-[#F8F3B9] text-[#9C7700]" : "bg-green-300 text-green-800"} px-3 py-1 items-center ml-2`}>{isSelected ? "In Progress" : "Open"}</button></div>
